...
## Idea:
Randomly generate a terrain, and eventually (see the [next sktech][sketch-ecosystem-2]) a set of resources that organisms will compete over.
...
> 🆕 NEW!! - Since this was originally written, p5.js added [paletteLerp][p5js-palettelerp]. 
> You can see that in action in this sketch example: [sketch-paletteLerp][sketch-paletteLerp].
> And my implementation prior to release/discovery of paletteLerp: [sketch-colorRamp][sketch-colorRamp]
...
[sketch-ecosystem-2]: https://brianhonohan.com/sketchbook/p5js/ecosystem-2/
[wikipedia-perlin]: https://en.wikipedia.org/wiki/Perlin_noise/

[sketch-paletteLerp]: https://brianhonohan.com/sketchbook/p5js/scales/palettelerp/
[sketch-colorRamp]: https://brianhonohan.com/sketchbook/p5js/common/examples/color-ramp/